...
public class XueshengliuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XueshengliuyanEntity() {

	}

	public XueshengliuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "Xueshengliuyan{" +
            ...
            ", xueshengliuyanText=" + xueshengliuyanText +
            ", replyText=" + replyText +
