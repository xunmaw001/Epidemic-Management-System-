...
public class DakaEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Daka{" +
            ...
            ", dakaTiwen=" + dakaTiwen +
            ", kesouTypes=" + kesouTypes +
            ", diqu=" + diqu +
            ", jiechuTypes=" + jiechuTypes +
            ", waidiTypes=" + waidiTypes +
            ", waidiContent=" + waidiContent +
            ", zhonggaoTypes=" + zhonggaoTypes +
            ", zhonggaoContent=" + zhonggaoContent +
            ", geliTypes=" + geliTypes +
            ", gelishijian=" + gelishijian +
