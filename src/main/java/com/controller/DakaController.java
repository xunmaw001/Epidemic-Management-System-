...
//                            dakaEntity.setDakaTiwen(data.get(0));                    //体温 要改的
//                            dakaEntity.setKesouTypes(Integer.valueOf(data.get(0)));   //是否咳嗽 要改的
//                            dakaEntity.setDiqu(data.get(0));                    //当前所在地区 要改的
//                            dakaEntity.setJiechuTypes(Integer.valueOf(data.get(0)));   //有无接触确诊病例 要改的
//                            dakaEntity.setWaidiTypes(Integer.valueOf(data.get(0)));   //近14天是否有外地旅居史 要改的
//                            dakaEntity.setWaidiContent("");//照片
//                            dakaEntity.setZhonggaoTypes(Integer.valueOf(data.get(0)));   //近14天是否有中高风险地区旅居史 要改的
//                            dakaEntity.setZhonggaoContent("");//照片
//                            dakaEntity.setGeliTypes(Integer.valueOf(data.get(0)));   //是否已隔离 要改的
//                            dakaEntity.setGelishijian(Integer.valueOf(data.get(0)));   //已隔离天数 要改的
//                            dakaEntity.setBeizhuContent("");//照片
