    ...
    */
    ...
    public R save(@RequestBody XueshengliuyanEntity xueshengliuyan, HttpServletRequest request){
        ...
        Wrapper<XueshengliuyanEntity> queryWrapper = new EntityWrapper<XueshengliuyanEntity>()
            ...
            .eq("xuesheng_name", xueshengliuyan.getXueshengName())
            .eq("xueshengliuyan_text", xueshengliuyan.getXueshengliuyanText())
            .eq("reply_text", xueshengliuyan.getReplyText())
            ;
...
//                            xueshengliuyanEntity.setXueshengName(data.get(0));                    //留言标题 要改的
//                            xueshengliuyanEntity.setXueshengliuyanText(data.get(0));                    //留言内容 要改的
//                            xueshengliuyanEntity.setReplyText(data.get(0));                    //回复 要改的
