    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="申请返校日期" prop="fanxiaoTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:ss:mm"
                                v-model="ruleForm.fanxiaoTime"
                                type="datetime"
                                placeholder="申请返校日期">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.fanxiaoTime" label="申请返校日期" prop="fanxiaoTime">
                            <span v-html="ruleForm.fanxiaoTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="当前地址" prop="diqu">
                       <el-input v-model="ruleForm.diqu"
                                 placeholder="当前地址" clearable  :readonly="ro.diqu"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="当前地址" prop="diqu">
                           <el-input v-model="ruleForm.diqu"
                                     placeholder="当前地址" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="返校方式" prop="fangshiTypes">
                        <el-select v-model="ruleForm.fangshiTypes" :disabled="ro.fangshiTypes" placeholder="请选择返校方式">
                            <el-option
                                v-for="(item,index) in fangshiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="返校方式" prop="fangshiValue">
                        <el-input v-model="ruleForm.fangshiValue"
                            placeholder="返校方式" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="返校车次" prop="checi">
                       <el-input v-model="ruleForm.checi"
                                 placeholder="返校车次" clearable  :readonly="ro.checi"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="返校车次" prop="checi">
                           <el-input v-model="ruleForm.checi"
                                     placeholder="返校车次" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="所在地区风险等级" prop="fengxianTypes">
                        <el-select v-model="ruleForm.fengxianTypes" :disabled="ro.fengxianTypes" placeholder="请选择所在地区风险等级">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="所在地区风险等级" prop="fengxianValue">
                        <el-input v-model="ruleForm.fengxianValue"
                            placeholder="所在地区风险等级" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="返校原因" prop="fanxiaoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.fanxiaoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.fanxiaoContent" label="返校原因" prop="fanxiaoContent">
                            <span v-html="ruleForm.fanxiaoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    checi: false,
                    fengxianTypes: false,
                    fanxiaoContent: false,
                    fanxiaoYesnoTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                ...
                rules: {
                   ...
                   diqu: [
                              { required: true, message: '当前地址不能为空', trigger: 'blur' },
                          ],
                   fangshiTypes: [
                              { required: true, message: '返校方式不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   checi: [
                              { required: true, message: '返校车次不能为空', trigger: 'blur' },
                          ],
                   fengxianTypes: [
                              { required: true, message: '所在地区风险等级不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   fanxiaoContent: [
                              { required: true, message: '返校原因不能为空', trigger: 'blur' },
                          ],
                   fanxiaoYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangshi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangshiTypesOptions = data.data.list;
                    }
                });
                this.$http({
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fanxiao_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fanxiaoYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='fanxiaoTime'){
                          this.ruleForm.fanxiaoTime = obj[o];
                          this.ro.fanxiaoTime = true;
                          continue;
                      }
                      if(o=='diqu'){
                      ...
                      if(o=='fangshiTypes'){
                          this.ruleForm.fangshiTypes = obj[o];
                          this.ro.fangshiTypes = true;
                          continue;
                      }
                      if(o=='checi'){
                      ...
                      if(o=='fengxianTypes'){
                          this.ruleForm.fengxianTypes = obj[o];
                          this.ro.fengxianTypes = true;
                          continue;
                      }
                      if(o=='fanxiaoContent'){
                          this.ruleForm.fanxiaoContent = obj[o];
                          this.ro.fanxiaoContent = true;
                          continue;
                      }
                      if(o=='fanxiaoYesnoTypes'){
                          this.ruleForm.fanxiaoYesnoTypes = obj[o];
                          this.ro.fanxiaoYesnoTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fanxiao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fanxiaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
