    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='xuesheng'">
                    <el-form-item class="select" v-if="type!='info'"  label="学生" prop="xueshengId">
                        <el-select v-model="ruleForm.xueshengId" filterable :disabled="ro.xueshengId" placeholder="请选择学生" @change="xueshengChange">
                            <el-option
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="留言标题" prop="xueshengName">
                       <el-input v-model="ruleForm.xueshengName"
                                 placeholder="留言标题" clearable  :readonly="ro.xueshengName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="留言标题" prop="xueshengName">
                           <el-input v-model="ruleForm.xueshengName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="xueshengliuyanText">
                        <el-input type="textarea"  :readonly="ro.xueshengliuyanText" v-model="ruleForm.xueshengliuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xueshengliuyanText" label="留言内容" prop="xueshengliuyanText">
                            <span v-html="ruleForm.xueshengliuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24"  v-if="sessionTable !='xuesheng'">
                    <el-form-item v-if="type!='info'"  label="回复" prop="replyText">
                        <el-input type="textarea"  :readonly="ro.replyText" v-model="ruleForm.replyText" placeholder="回复"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.replyText" label="回复" prop="replyText">
    ...
    export default {
        ...
        created() {
            ...
            if (this.role == "管理员"){
                ...
                this.ro.xueshengliuyanText = true;
            }
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xueshengliuyanText'){
                          this.ruleForm.xueshengliuyanText = obj[o];
                          this.ro.xueshengliuyanText = true;
                          continue;
                      }
                      if(o=='replyText'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xueshengliuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xueshengliuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
