        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.laoshiPhoto" label="老师照片" prop="laoshiPhoto">
                        <file-upload
                            tip="点击上传老师照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.laoshiPhoto" label="老师照片" prop="laoshiPhoto">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   laoshiPhoto: [
                              { required: true, message: '老师照片不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
