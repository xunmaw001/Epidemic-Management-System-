            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xueshengUuidNumber'){
                          this.ruleForm.xueshengUuidNumber = obj[o];
                          this.ro.xueshengUuidNumber = true;
                          continue;
                      }
                      if(o=='xueshengName'){
                      ...
                      if(o=='xueshengEmail'){
                          this.ruleForm.xueshengEmail = obj[o];
                          this.ro.xueshengEmail = true;
                          continue;
                      }
                    }
                }
