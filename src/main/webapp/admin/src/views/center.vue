    ...
    <div>
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item v-if="flag=='laoshi'" label='老师照片' prop="laoshiPhoto">
                        <file-upload
                                tip="点击上传照片"
                                action="file/upload"
                                :limit="3"
                ...
                <el-col :span="12">
                    <el-form-item v-if="flag=='xuesheng'" label='学生照片' prop="xueshengPhoto">
                        <file-upload
                                tip="点击上传照片"
                                action="file/upload"
                                :limit="3"
